<?php /* Smarty version 2.6.29, created on 2019-01-13 20:39:26
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_reports_to_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["reports_to_name_basic","reports_to_id_basic"],"required_list":["reports_to_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Pas de correspondance"};sqs_objects[\'search_form_dash_dashboardmanager_users_name_basic\']={"form":"search_form","method":"query","modules":["dash_DashboardManager"],"group":"or","field_list":["name","id"],"populate_list":["dash_dashboardmanager_users_name_basic","dash_dashboardmanager_usersdash_dashboardmanager_ida_basic"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Pas de correspondance"};sqs_objects[\'search_form_dash_dashboardmanager_users_2_name_basic\']={"form":"search_form","method":"query","modules":["dash_DashboardManager"],"group":"or","field_list":["name","id"],"populate_list":["dash_dashboardmanager_users_2_name_basic","dash_dashboardmanager_users_2dash_dashboardmanager_ida_basic"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Pas de correspondance"};sqs_objects[\'search_form_dash_dashboardmanager_users_1_name_basic\']={"form":"search_form","method":"query","modules":["dash_DashboardManager"],"group":"or","field_list":["name","id"],"populate_list":["dash_dashboardmanager_users_1_name_basic","dash_dashboardmanager_users_1dash_dashboardmanager_ida_basic"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Pas de correspondance"};</script>'; ?>