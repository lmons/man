...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SUBMITTED_CALLS','module' => 'Thin_CyclePlans'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td class="inlineEdit" type="varchar" field="submitted_calls" width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['submitted_calls']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
"><?php echo $this->_tpl_vars['fields']['submitted_calls']['value']; ?>
</span>
<?php endif; ?>
<div class="inlineEditIcon"> <?php echo smarty_function_sugar_getimage(array('name' => "inline_edit_icon.svg",'attr' => 'border="0" ','alt' => ($this->_tpl_vars['alt_edit'])), $this);?>
</div>			</td>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['terri_territoire_thin_cycleplans_1_name']['hidden']): ?>
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TERRI_TERRITOIRE_THIN_CYCLEPLANS_1_FROM_TERRI_TERRITOIRE_TITLE','module' => 'Thin_CyclePlans'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td class="inlineEdit" type="relate" field="terri_territoire_thin_cycleplans_1_name" width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['terri_territoire_thin_cycleplans_1_name']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['terri_territoire_thin_cycleplans_1terri_territoire_ida']['value'] )): ?>
<?php ob_start(); ?>index.php?module=Terri_Territoire&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['terri_territoire_thin_cycleplans_1terri_territoire_ida']['value']; ?>
...
"><?php endif; ?>
<span id="terri_territoire_thin_cycleplans_1terri_territoire_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['terri_territoire_thin_cycleplans_1terri_territoire_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['terri_territoire_thin_cycleplans_1_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['terri_territoire_thin_cycleplans_1terri_territoire_ida']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
<div class="inlineEditIcon"> <?php echo smarty_function_sugar_getimage(array('name' => "inline_edit_icon.svg",'attr' => 'border="0" ','alt' => ($this->_tpl_vars['alt_edit'])), $this);?>
</div>			</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<td width='12.5%' scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRODUCTIVE_FREQUENCY','module' => 'Thin_CyclePlans'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<span id="" class="sugar_field"><div id="myProgress" class="myProgress" style=" width: 100%;border-radius: 25px;background-color: #F12;" title="">
