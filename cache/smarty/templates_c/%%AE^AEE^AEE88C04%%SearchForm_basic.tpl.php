<?php /* Smarty version 2.6.29, created on 2019-01-13 21:18:38
         compiled from cache/themes/SuiteR/modules/Thin_CyclePlanTargets_Pharma/SearchForm_basic.tpl */ ?>
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'Thin_CyclePlanTargets_Pharma'), $this);?>
...
' title=''      accesskey='9'  >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='current_user_only_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENT_USER_FILTER','module' => 'Thin_CyclePlanTargets_Pharma'), $this);?>
</label>
    	</td>
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_basic","modified_user_id_basic"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Pas de correspondance"};sqs_objects[\'search_form_created_by_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_basic","created_by_basic"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Pas de correspondance"};sqs_objects[\'search_form_assigned_user_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_basic","assigned_user_id_basic"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Pas de correspondance"};sqs_objects[\'search_form_thin_cycleplans_thin_cycleplantargets_pharma_1_name_basic\']={"form":"search_form","method":"query","modules":["Thin_CyclePlans"],"group":"or","field_list":["name","id"],"populate_list":["thin_cycleplans_thin_cycleplantargets_pharma_1_name_basic","thin_cycled5c3leplans_ida_basic"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Pas de correspondance"};sqs_objects[\'search_form_accounts_thin_cycleplantargets_pharma_1_name_basic\']={"form":"search_form","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["search_form_accounts_thin_cycleplantargets_pharma_1_name_basic","accounts_thin_cycleplantargets_pharma_1accounts_ida_basic"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["accounts_thin_cycleplantargets_pharma_1accounts_ida"],"order":"name","limit":"30","no_match_text":"Pas de correspondance"};</script>'; ?>