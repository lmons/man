...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> {sugar_translate label='LBL_NAME' module='Thin_CyclePlans'}
		</td>
...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='current_user_only_basic' >{sugar_translate label='LBL_CURRENT_USER_FILTER' module='Thin_CyclePlans'}</label>
    	</td>
...
value="1" title='' tabindex="" {$checked} >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='cp_type_c_basic' >{sugar_translate label='LBL_CP_TYPE' module='Thin_CyclePlans'}</label>
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{html_options id='cp_type_c_basic' name='cp_type_c_basic[]' options=$fields.cp_type_c_basic.options size="6" style="width: 150px" multiple="1" selected=$fields.cp_type_c_basic.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='active_basic' >{sugar_translate label='LBL_ACTIVE' module='Thin_CyclePlans'}</label>
    	</td>
