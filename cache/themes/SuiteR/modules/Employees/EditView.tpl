...
addToValidate('EditView', 'dash_dashboardmanager_users_name', 'relate', false,'{/literal}{sugar_translate label='LBL_DASH_DASHBOARDMANAGER_USERS_FROM_DASH_DASHBOARDMANAGER_TITLE' module='Employees' for_js=true}{literal}' );
addToValidate('EditView', 'dash_dashboardmanager_users_2_name', 'relate', false,'{/literal}{sugar_translate label='LBL_DASH_DASHBOARDMANAGER_USERS_2_FROM_DASH_DASHBOARDMANAGER_TITLE' module='Employees' for_js=true}{literal}' );
addToValidate('EditView', 'dash_dashboardmanager_users_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_DASH_DASHBOARDMANAGER_USERS_1_FROM_DASH_DASHBOARDMANAGER_TITLE' module='Employees' for_js=true}{literal}' );
