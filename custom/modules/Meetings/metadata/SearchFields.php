...
$searchFields['Meetings']['my_planned_tm_team'] = array(
	'query_type'=>'format',
	'operator' => 'subquery',
	'type'=>'bool',
	'checked_only' => true,
	'subquery' => 'SELECT id FROM meetings WHERE meetings.deleted=0 AND meetings.status="Planned" and assigned_user_id!="'.$current_user->id.'"',
	'db_field' => array(
		'id',
	),
);
