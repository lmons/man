...
function checkInRestriction(){
    ...
    $.ajax({
        ...
        success: function(data){
           ...
           if(obj.planConf.enable_restriction_plan_adv && obj.planConf.enable_restriction_plan && obj.planConf.nextWeek!='' && status=='Planned' && checkIfCrossLastDays(NumberOfCurrentDay,submitDate,firstDays,lastDayOfWeekDate,weeks)){
              console.log("2");
                bool= true;
            }
